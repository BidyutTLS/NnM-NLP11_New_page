  ...
  return (
    <section className="bg-[#fcfcfc] text-[#1a1a1a] py-10 px-4 text-center">
      ...
      <div className="mt-6 max-w-4xl mx-auto space-y-4 text-lg">
        ...
        <p>
          We’re all for producing more...but sourcing the rare ingredients of the{" "}
          <span className="bg-gold text-[#590632] font-inter font-semibold px-1">
            highest quality often limits our production.
          </span>
        </p>
        <p className="font-semibold">The truth is...</p>
        <p>
          .... it’s not just a random cosmetic product —{" "}
          <span className="font-bold">
            it’s a real investment for your hair, confidence, and femininity.
          </span>
        </p>
        <p>
          Smart women have already figured this out, ordering in bulk to have a backup{" "}
          <span className="font-bold">supply for at least 6 and even 9 months!</span>
        </p>
      </div>
      ...
      <div className="mt-6 text-lg max-w-4xl mx-auto">
        <p>
          Order your 3-bottle pack NOW! Plus, you’re getting{" "}
          <span className="font-bold">EXTRA benefits</span> with our{" "}
          <span className="font-bold">STEAL DEAL</span>: 3 bottles at a discounted price of
        </p>
      ...
      <div className="mt-6">
        <button
          ...
          className="bg-[#590632] hover:bg-[#3b0225] transition-colors text-white font-inter font-bold py-3 px-8 rounded-lg text-lg"
        >
          ADD TO CART
        </button>
      </div>
