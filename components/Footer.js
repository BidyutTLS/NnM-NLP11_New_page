...
const Footer = () => (
  <footer className="bg-white border-t text-sm text-gray-700 px-4 pt-10 pb-4 font-['Open_Sans']">
    {/* Main layout */}
    <div className="w-full flex flex-col lg:flex-row justify-between gap-6 max-w-7xl mx-auto">
      {/* Logo + Contact */}
      <div className="lg:w-1/4 text-center lg:text-left">
        <Image src="/logo.png" alt="TAE Logo" width={220} height={60} />
        ...
        <p className="mt-4"><strong>Need Help?</strong></p>
        ...
        <div className="flex justify-center lg:justify-start gap-5 mt-4 text-xl">
      ...
      {/* Links */}
      <div className="lg:w-3/4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center lg:text-left">
