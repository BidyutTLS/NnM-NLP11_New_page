        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-0 mt-12 justify-items-center">
          ...
          <div className="flex flex-col items-center">
            <Image
              ...
              unoptimized
            />
            <div className="bg-black text-gold text-center mt-2 py-2 px-4 w-full font-inter font-bold text-sm leading-tight border border-gold">
          ...
          <div className="flex flex-col items-center">
            <Image
              ...
              unoptimized
            />
            <div className="bg-black text-gold text-center mt-2 py-2 px-4 w-full font-bold text-sm leading-tight border border-gold">
